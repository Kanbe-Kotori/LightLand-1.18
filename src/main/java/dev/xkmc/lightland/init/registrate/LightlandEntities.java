...
public class LightlandEntities {
	...
	public static final EntityEntry<EntityMagnetCore> MAGNET_CORE;
	...
	static {
		...
		RAINBOW_ORB = LightLand.REGISTRATE
				...
				.defaultLang().register();
		MAGNET_CORE = LightLand.REGISTRATE
				.<EntityMagnetCore>entity("magnet_core", EntityMagnetCore::new, MobCategory.MISC)
				.properties(e -> e.sized(0.5F, 0.5F)
						.clientTrackingRange(4).updateInterval(20)
						.setShouldReceiveVelocityUpdates(true))
				.renderer(() -> RenderMagnetCore::new)
				.defaultLang().register();
	}
